...
function Home() {
  const technologyNewsEndpoint = getNewsCategoriesEndpoint("technology", 1, 9);
  const footballNewsEndpoint = getNewsCategoriesEndpoint("football", 1, 9);
  const gamesNewsEndpoint = getNewsCategoriesEndpoint("games", 1, 9);
  ...
  return (
    <Layout>
      ...
      <section className="games my-5">
        <Container>
          <h1 className="mb-5 pt-3">Gaming</h1>
          <NewsCardList newsList={adaptedGamesData} />
          <p>
            Vezi toate știrile legate de gaming în secțiunea{" "}
